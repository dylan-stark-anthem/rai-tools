...
def simple_undrifted_record(simple_undrifted_bundle_path: Path) -> DataDriftRecord:
    ...
    expected_record_dict = {
        ...
        "bundle": {
            ...
            "manifest": {
                "bundle_path": simple_undrifted_bundle_path,
